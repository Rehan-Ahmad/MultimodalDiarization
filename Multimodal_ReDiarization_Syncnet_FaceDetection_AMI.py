...
if __name__ == '__main__':
    ...
    for cvid in range(4):
        ...
        AudioDataSet = 'IS1008d' #DiaExample,IS1008a,etc.
        ...
        w = 224
        h = 224
        UseFDPickle = False # True if FaceDetection pickle is already saved.

        # =====================================================================
        # Read saved facedetection pickle.        
        # =====================================================================
        if UseFDPickle:
            PickFile = '../data/AMI/'+AudioDataSet+'/video/'+AudioDataSet+\
            '.Closeup'+str(cvid+1)+'.facedetect.pickle'
            with open(PickFile,'rb') as p:
                pikdata = pickle.load(p) 

            facedetectind = pikdata['facedetectind']
            bslist = pikdata['bslist']
            cropxlist = pikdata['cropxlist']
            cropylist = pikdata['cropylist']
            trbl = pikdata['trbl']
            del pikdata
            ...
            while(cap.isOpened()):
                ...
                if ret==True:
                    if framenum not in facedetectind:
        ...
        # =====================================================================
        # Save facedetection as a pickle.
        # =====================================================================
#        facedict = {'facedetectind':facedetectind, 'bslist':bslist, \
#                    'cropxlist':cropxlist, 'cropylist':cropylist, 'trbl':trbl}
# 
#        with open('output/'+AudioDataSet+'/'+AudioDataSet+'.'+video[0:-4]+'.facedetect.pickle', 'wb') as f:
#            pickle.dump(facedict,f)
#        del facedict
#        print('=== face detection pickle saved ===')
        # =========================================================================
